...
(function($,globals){
	...
	function pullVolunteers(){
		var z = `https://boards.${region}.leagueoflegends.com/api/LMxoEARA/discussions/yyKrU1eL?page_size=0`;
		//var curr = this;
		...
		xmlhttp.onreadystatechange = function() {
			if (this.readyState == 4 && this.status === 200) {
				...
				globals.GLOB.Group6 = volParts[11].split(',');
				globals.GLOB.Group7 = volParts[13].split(',');
			}
		};
		...
		if(globals.GLOB.Group1){
			$("a.profile-hover:not(.cka)").each(function(){
				...
				if($this.parent().hasClass("isRioter") === false){
					newFlares(globals.GLOB.Group1,globals.GLOB.Group2,globals.GLOB.Group3,globals.GLOB.Group4,globals.GLOB.Group5,globals.GLOB.Group6,globals.GLOB.Group7,$this);
				} else {
					Tags($this);
				}
			});
	...
	function newFlares(Group1,Group2,Group3,Group4,Group5,Group6,Group7,$this){
		var i;
		var apolloID = $this.attr('data-apollo-pvpnet-id');
		for(i=Group1.length-1;i>-1;i-=1){
			if(apolloID === Group1[i]){
				$this.parents('.byline:not(.discussion-footer)').find(".inline-profile:first").append("<span class='tags cemissary'><a href='https://boards."+region+".leagueoflegends.com/"+lang+"/c/announcements-en/91vEPc8g'>Senior Emissary</a></span>").end().end()
		...
		for(i=Group2.length-1;i>-1;i-=1){
			if(apolloID === Group2[i]){
				$this.parents('.byline:not(.discussion-footer)').find(".inline-profile:first").append("<span class='tags cemissary'><a href='https://boards."+region+".leagueoflegends.com/"+lang+"/c/announcements-en/91vEPc8g'>Emissary</a></span>").end().end()
						.closest('.nested-comment').find('.masthead:first').append("<span class='ttriangle temissary'></span>").end().end()
						.closest('.nested-comment:not(.glow):not(.flat)').attr("style","border-top:1px solid #458b00").end()
						.attr("id","emissary");
			}
		...
		for(i=Group3.length-1;i>-1;i-=1){
			if(apolloID === Group3[i]){
				$this.parents('.byline:not(.discussion-footer)').find(".inline-profile:first").append("<span class='tags cemissary'><a href='https://boards."+region+".leagueoflegends.com/"+lang+"/c/announcements-en/91vEPc8g'>Junior Emissary</a></span>").end().end()
						.closest('.nested-comment').find('.masthead:first').append("<span class='ttriangle temissary'></span>").end().end()
						.closest('.nested-comment:not(.glow):not(.flat)').attr("style","border-top:1px solid #458b00").end()
						.attr("id","emissary");
			}
		...
		for(i=Group4.length-1;i>-1;i-=1){
			if(apolloID === Group4[i]){
				$this.parents('.byline:not(.discussion-footer)').find(".inline-profile:first").append("<span class='tags cwrenchman'><a href='https://boards."+region+".leagueoflegends.com/"+lang+"/c/help-support-en/EXtUdIss'>Senior Wrenchman</a></span>").end().end()
		...
		for(i=Group5.length-1;i>-1;i-=1){
			if(apolloID === Group5[i]){
				$this.parents('.byline:not(.discussion-footer)').find(".inline-profile:first").append("<span class='tags cwrenchman'><a href='https://boards."+region+".leagueoflegends.com/"+lang+"/c/help-support-en/EXtUdIss'>Wrenchman</a></span>").end().end()
						.closest('.nested-comment').find('.masthead:first').append("<span class='ttriangle twrenchman'></span>").end().end()
						.closest('.nested-comment:not(.glow):not(.flat)').attr("style","border-top:1px solid #ff5214").end()
						.attr("id","wrenchman");
			}
		}
		for(i=Group6.length-1;i>-1;i-=1){
			if(apolloID === Group6[i]){
				$this.parents('.byline:not(.discussion-footer)').find(".inline-profile:first").append("<span class='tags cwrenchman'><a href='https://boards."+region+".leagueoflegends.com/"+lang+"/c/help-support-en/EXtUdIss'>Junior Wrenchman</a></span>").end().end()
						.closest('.nested-comment').find('.masthead:first').append("<span class='ttriangle twrenchman'></span>").end().end()
						.closest('.nested-comment:not(.glow):not(.flat)').attr("style","border-top:1px solid #ff5214").end()
						.attr("id","wrenchman");
			}
		}
		for(i=Group7.length-1;i>-1;i-=1){
			if(apolloID === Group7[i]){
				$this.parents('.byline:not(.discussion-footer)').find(".inline-profile:first").append("<span class='tags ceups'>Player Support Specialist</span>").end().end()
						.closest('.nested-comment').find('.masthead:first').append("<span class='ttriangle teups'></span>").end().end()
						.closest('.nested-comment:not(.glow):not(.flat)').attr("style","border-top:1px solid #5ea295").end()
						.attr("id","eups");
			}
		}
	}
